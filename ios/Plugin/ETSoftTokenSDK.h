 ...
 *  @param txnUrl identity provider address
 *  @param identities array of soft token identities
 *  @param errorPtr holds the error during operation
 *  @return the identities list flagged with face recognition offline validation
 ...
 *  @return FPBMatcherLicenseManager instance, null if no instance found
 */
